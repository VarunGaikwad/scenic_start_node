...
const emailExistsRouter = (0, express_1.Router)();
/**
 * @swagger
 * /unauth/email-exists:
 *   post:
...
emailExistsRouter.post("/", async (req, res) => {
    ...
    try {
        ...
        const user = await db.collection("users").findOne({ email: normalizedEmail }, { projection: { _id: 1 } });
...
exports.default = emailExistsRouter;
