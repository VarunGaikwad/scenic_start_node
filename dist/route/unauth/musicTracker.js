...
const musicTrackerRouter = (0, express_1.Router)();
...
musicTrackerRouter.post("/", (req, res) => {
    const { name, artist, imageUrl = "", currentTime, totalTime, isPlaying, songUrl, } = req.body;
    // Validate types
...
exports.default = musicTrackerRouter;
