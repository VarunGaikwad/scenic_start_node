...
const shayariAndQuotesRouter = Router();
 ...
 *               $ref: '#/components/schemas/Error'
 */
shayariAndQuotesRouter.get("/", async (req: Request, res: Response) => {
  try {
  ...
  async (req: AuthRequest, res: Response) => {
    ...
    try {
      ...
      const newDocs = docs.filter(
        (d: any) => !existingSet.has(d.normalizedText),
      );
...
export default shayariAndQuotesRouter;
